...
```shell
go install github.com/lonegunmanb/terraform-azurerm-resource-template/v3/newres
```
...
For example, to generate configuration files for an Aks cluster in the current working directory, you would run:

```shell
newres -dir ./ -r azurerm_kubernetes_cluster
```
