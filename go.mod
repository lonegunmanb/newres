...
require (
	...
	github.com/lonegunmanb/terraform-alicloud-schema v1.228.0
	...
	github.com/lonegunmanb/terraform-aws-schema/v5 v5.64.0
	github.com/lonegunmanb/terraform-awscc-schema v1.10.0
	...
	github.com/lonegunmanb/terraform-google-schema/v5 v5.42.0
	github.com/lonegunmanb/terraform-helm-schema/v2 v2.15.0
