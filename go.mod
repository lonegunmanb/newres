...
require (
	...
	github.com/lonegunmanb/terraform-alicloud-schema v1.250.0
	...
	github.com/lonegunmanb/terraform-awscc-schema v1.43.0
	...
	github.com/lonegunmanb/terraform-google-schema/v6 v6.37.0
