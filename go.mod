...
require (
	...
	github.com/lonegunmanb/terraform-aws-schema/v5 v5.62.0
	github.com/lonegunmanb/terraform-awscc-schema v1.8.0
	...
	github.com/lonegunmanb/terraform-google-schema/v5 v5.40.0
