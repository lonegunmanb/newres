...
require (
	...
	github.com/lonegunmanb/terraform-aws-schema/v5 v5.96.0
	github.com/lonegunmanb/terraform-awscc-schema v1.37.0
	...
	github.com/lonegunmanb/terraform-google-schema/v6 v6.30.0
