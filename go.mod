...
require (
	...
	github.com/lonegunmanb/terraform-alicloud-schema v1.213.0
	...
	github.com/lonegunmanb/terraform-azurerm-schema/v3 v3.82.0
	...
	github.com/lonegunmanb/terraform-helm-schema/v2 v2.11.0
