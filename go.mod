...
require (
	...
	github.com/lonegunmanb/terraform-alicloud-schema v1.231.0
	...
	github.com/lonegunmanb/terraform-aws-schema/v5 v5.72.1
	github.com/lonegunmanb/terraform-awscc-schema v1.16.1
	...
	github.com/lonegunmanb/terraform-google-schema/v5 v5.44.1
