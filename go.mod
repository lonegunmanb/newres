...
require (
	...
	github.com/lonegunmanb/terraform-alicloud-schema v1.217.2
	...
	github.com/lonegunmanb/terraform-aws-schema/v5 v5.38.0
	github.com/lonegunmanb/terraform-awscc-schema v0.71.0
