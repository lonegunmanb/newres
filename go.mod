...
require (
	...
	github.com/lonegunmanb/terraform-alicloud-schema v1.229.1
	...
	github.com/lonegunmanb/terraform-aws-schema/v5 v5.65.0
	github.com/lonegunmanb/terraform-awscc-schema v1.13.0
	...
	github.com/lonegunmanb/terraform-google-schema/v5 v5.43.1
	github.com/lonegunmanb/terraform-helm-schema/v2 v2.15.0
	github.com/lonegunmanb/terraform-kubernetes-schema/v2 v2.32.0
