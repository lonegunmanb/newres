...
require (
	...
	github.com/lonegunmanb/terraform-alicloud-schema v1.245.0
	...
	github.com/lonegunmanb/terraform-awscc-schema v1.34.0
	...
	github.com/lonegunmanb/terraform-google-schema/v6 v6.26.0
