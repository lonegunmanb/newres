...
require (
	...
	github.com/lonegunmanb/terraform-alicloud-schema v1.227.1
	...
	github.com/lonegunmanb/terraform-aws-schema/v5 v5.61.0
	github.com/lonegunmanb/terraform-awscc-schema v1.7.0
	...
	github.com/lonegunmanb/terraform-google-schema/v5 v5.39.1
