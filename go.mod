...
require (
	...
	github.com/lonegunmanb/terraform-alicloud-schema v1.227.0
	...
	github.com/lonegunmanb/terraform-aws-schema/v5 v5.58.0
	github.com/lonegunmanb/terraform-awscc-schema v1.6.0
	...
	github.com/lonegunmanb/terraform-google-schema/v5 v5.37.0
