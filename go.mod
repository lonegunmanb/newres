...
require (
	...
	github.com/lonegunmanb/terraform-aws-schema/v5 v5.21.0
	github.com/lonegunmanb/terraform-azapi-schema v1.9.0
	github.com/lonegunmanb/terraform-azuread-schema/v2 v2.44.0
	github.com/lonegunmanb/terraform-azurerm-schema/v2 v2.99.0
	github.com/lonegunmanb/terraform-azurerm-schema/v3 v3.76.0
