...
require (
	...
	github.com/lonegunmanb/terraform-alicloud-schema v1.225.0
	...
	github.com/lonegunmanb/terraform-aws-schema/v5 v5.55.0
	github.com/lonegunmanb/terraform-awscc-schema v1.2.0
	github.com/lonegunmanb/terraform-azapi-schema v1.13.1
	github.com/lonegunmanb/terraform-azuread-schema/v2 v2.52.0
	...
	github.com/lonegunmanb/terraform-google-schema/v5 v5.34.0
	github.com/lonegunmanb/terraform-helm-schema/v2 v2.14.0
	github.com/lonegunmanb/terraform-kubernetes-schema/v2 v2.31.0
