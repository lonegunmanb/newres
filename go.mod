...
require (
	...
	github.com/lonegunmanb/terraform-alicloud-schema v1.214.1
	...
	github.com/lonegunmanb/terraform-aws-schema/v5 v5.31.0
	github.com/lonegunmanb/terraform-azapi-schema v1.11.0
	github.com/lonegunmanb/terraform-azuread-schema/v2 v2.47.0
	github.com/lonegunmanb/terraform-azurerm-schema/v2 v2.99.0
	github.com/lonegunmanb/terraform-azurerm-schema/v3 v3.86.0
	...
	github.com/lonegunmanb/terraform-kubernetes-schema/v2 v2.24.0
